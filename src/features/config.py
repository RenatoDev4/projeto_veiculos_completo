...
DADOS = pd.read_csv('data/processed/name_you_want.csv',
                    sep=',', na_values=['N/D'])
DADOS_MACHINE_LEARNING = pd.read_csv(
    'data/processed/name_you_want.csv', sep=',')
CLEAN_WANT_DF = 'data/interim/precos_carros.csv'
LL_DF = 'data/interim/latitude-longitude-cidades.csv'
...
with open('models/modelo_rf_otimizado_target.pkl', 'rb') as model_file:
    MODELO = pickle.load(model_file)

with open('references/mapa_veiculos.html', 'r') as file:
    MAPA = file.read()
